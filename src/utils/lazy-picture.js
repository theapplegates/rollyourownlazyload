...
module.exports = (url, alt = "Missing alt text") => {
  ...
  <source srcset="/images/tiny/${url}" media="(min-width: 2150px)">
  ...
  <source srcset="/images/tiny/${url}" media="(min-width: 400px)">
  <source srcset="/images/tiny/${url}" media="(min-width: 200px)">
